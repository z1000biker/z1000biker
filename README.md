...
I design and build technical systems intended for real operational contexts rather than demonstrations. My current direction increasingly combines systems engineering with open-source research, claim verification, information integrity and analyst-assisted decision support.

---

## Current Research Direction

I am extending my work toward digital verification, disinformation research and information integrity.

Current areas of interest include:

- claim decomposition and structured verification
- source provenance and evidence tracing
- prior fact-check discovery
- temporal consistency analysis
- citation support assessment
- AI-assisted analyst workflows
- technical verification of claims involving AI, cybersecurity, telecommunications, RF systems and emerging technologies
...
- Technical research and evidence evaluation
- Backend system design and implementation
- AI and machine learning workflows
- Event-driven and real-time architectures
- Deterministic state machines and business logic
- API design and service boundaries
- Data modeling and persistence
- Security, access control and compliance-aware systems
- Telecommunications and software-defined radio systems
- Hardware and software boundary design
- Analyst-assisted decision support
- Auditability and traceable system behaviour
- Clear architectural and technical documentation
...
My work spans several areas that are increasingly relevant to technical verification and information integrity:

- Artificial intelligence and machine learning
- Cybersecurity and cyber-risk analysis
...
- Evidence-aware analytical workflows

---

## Teaching and Educational Work

Earlier in my career, I worked extensively as an educator, lecturer and mentor, creating repositories used for teaching backend development, AI, machine learning, 3D graphics, IoT, networking, cybersecurity, software engineering fundamentals and system design.

These repositories were designed for learning environments and emphasize:

- fundamental concepts of optimization
- progressive introduction of complexity
- readable and explicit code
- didactic structure rather than production constraints

Several older repositories on this profile reflect this teaching role and should be interpreted in that context.

My current pinned repositories represent my present professional focus on technical research, AI, cybersecurity, backend systems, digital verification and high-integrity software for real-world environments.

---

## Location and Work

I am based in Greece and interested in remote or hybrid opportunities across the UK, Northern and Central Europe and North America.

I am open to relocation for the right role.

My main interests are technically demanding positions involving:
...
- analyst-assisted decision support
- telecommunications and technical investigations
